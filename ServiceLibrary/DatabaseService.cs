    ...
    public class DatabaseService : IDatabaseService
    {
        ...
        public DatabaseService()
        {
            try
            {
                ...
                _exceptionLogItemContext.Database.ExecuteSqlInterpolated($"CREATE TABLE IF NOT EXISTS ExceptionLogItems (Id INTEGER PRIMARY KEY AUTOINCREMENT, TimeStamp NUMERIC, Message TEXT, Source TEXT, StackTrace TEXT)");
            ...
            try
            {
                ...
                agendaItemContext.Database.ExecuteSqlInterpolated($"CREATE TABLE IF NOT EXISTS AgendaItems (Id INTEGER PRIMARY KEY AUTOINCREMENT, Title TEXT, Start NUMERIC , End NUMERIC , Description TEXT, IsAllDayEvent INTEGER, IsOverridden INTEGER, Occupancy INTEGER, TimeStamp NUMERIC, IsDeleted INTEGER)");
            ...
            try
            {
                ...
                _timespanItemContext.Database.ExecuteSqlInterpolated($"CREATE TABLE IF NOT EXISTS TimeSpanItems (Id INTEGER PRIMARY KEY AUTOINCREMENT, DayOfWeek INTEGER, Start NUMERIC , End NUMERIC, Occupancy INTEGER, TimeStamp NUMERIC, IsDeleted INTEGER)");
